...
var Lexer, binary, constants, decoder, match,
...
module.exports = Lexer = (function() {
  ...
  Lexer.prototype.float = function() {
    var bytes;
    this.forward(4);
    bytes = [this.d[this.i - 4], this.d[this.i - 3], this.d[this.i - 2], this.d[this.i - 1]];
    return binary.readFloat(bytes);
  };

  Lexer.prototype.double = function() {
    var bytes;
    this.forward(8);
    bytes = [this.d[this.i - 8], this.d[this.i - 7], this.d[this.i - 6], this.d[this.i - 5], this.d[this.i - 4], this.d[this.i - 3], this.d[this.i - 2], this.d[this.i - 1]];
    return binary.readFloat(bytes);
  };
  ...
  Lexer.prototype.readerForType = function(type, fill) {
    var f;
    if (this[type + "s"] == null) {
  ...
  Lexer.prototype.fillForType = function(type) {
    if (constants[type + "Fill"] == null) {
